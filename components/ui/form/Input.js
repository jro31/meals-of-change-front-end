    ...
    <div className={`relative mt-1 ${props.className || ''}`}>
      <div className='flex flex-col w-full'>
        ...
        <input
          ...
          className='peer text-slate-400 border border-slate-300 bg-slate-100 p-1.5 sm:p-2 text-lg rounded-lg focus:outline-none placeholder-transparent focus:ring-0 focus:border-slate-400 focus:bg-slate-200 w-full disabled:bg-slate-300 disabled:text-slate-500 disabled:border-slate-500'
